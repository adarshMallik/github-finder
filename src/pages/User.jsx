...
function User() {
    ...
    useEffect(() => {
      ...
      const getReposData = async () => {
        const repo = await getRepos(params.login)
        dispatch({
                type: 'GET_REPOS',
                payload: repo,
            })
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaUsers className='text-3xl md:text-5xl text-pink-600'/>
                </div>
            ...
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaCodepen className='text-3xl md:text-5xl text-pink-600'/>
                </div>
                <div className="stat-title pr-5">
                    Public Repos
                </div>
            ...
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaStore className='text-3xl md:text-5xl text-pink-600'/>
                </div>
                <div className="stat-title pr-5">
                    Public Gists
                </div>
